...
export default function Footer() {
  ...
  return (
    <footer className="bg-accent-950 text-gray-300">
      {/* Main Footer */}
  ...
  />
              ...
              <div>
                ...
                <p className="text-xs text-accent-400 font-medium">Expert Digestive Care</p>
              </div>
            </div>
            ...
            <div className="flex gap-3">
              <a
                ...
                aria-label="Facebook"
                className="w-9 h-9 rounded-lg bg-gray-800 hover:bg-accent-600 flex items-center justify-center transition-all duration-200 hover:-translate-y-0.5"
              >
              ...
              <a
                href="https://www.youtube.com/@gastroclinic27"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="YouTube"
                className="w-9 h-9 rounded-lg bg-gray-800 hover:bg-accent-600 flex items-center justify-center transition-all duration-200 hover:-translate-y-0.5"
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a href={`tel:${doctorInfo.phone}`} className="text-sm text-gray-300 hover:text-accent-400 transition-colors font-medium">
                    {doctorInfo.phone}
                  </a>
                </div>
              </li>
              <li className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a href={`mailto:${doctorInfo.email}`} className="text-sm text-gray-300 hover:text-accent-400 transition-colors">
                    {doctorInfo.email}
                  </a>
                </div>
              </li>
